        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          ...
          >
            <p className='text-lg mb-8 pt-3'>
              Hello, I'm Tianhi Devold, a front-end developer from Norway and I'm 25 years old. I'm majoring in front-end development at Kristiania University College right now. However, this spring (2024), I'm taking an exchange semester at SUU in Utah, US, in hopes of learning new skills and meeting people from around the world.<br /><br />
